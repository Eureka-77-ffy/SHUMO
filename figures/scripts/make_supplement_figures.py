...
if __name__ == "__main__":
    # Keep the established command stable; the formal renderer adds the
    # cross-metric summary and the spatial-decay/refinement diagnostics.
    from figures.scripts.make_formal_enriched_supplements import main as enriched_main
